...
La configuracion general para un __switch o router administrable__ es similar, ya que debemos acceder a traves de un emulador de terminal y colocar todo parametro correspondiente a un _valor personalizado en mayusculas_, como el nombre del dispositivo, para identificarlo con mayor facilidad.
