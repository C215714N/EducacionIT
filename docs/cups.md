...
CUPS es una herramienta poderosa y flexible para la gestión de impresoras en sistemas Unix. Con su soporte para múltiples protocolos y su interfaz fácil de usar, facilita la impresión en entornos de red.
