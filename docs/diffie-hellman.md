...
* Alice y Bob acuerdan usar __p = 7__ y __g = 3__.
* Alice elige __a = 5__ y Bob elige __b = 3__.
* Alice calcula __A = g^a mod p = 3^5 mod 7 = 5__.
* Bob calcula __B = g^b mod p = 3^3 mod 7 = 6__.
* Alice envía __A = 5__ a Bob y Bob envía __B = 6__ a Alice.
* Alice calcula la clave compartida: __s = B^a mod p = 6^5 mod 7 = 6__.
* Bob calcula la clave compartida: __s = A^b mod p = 5^3 mod 7 = 6__. 

En este ejemplo, ambos participantes obtienen la misma clave compartida (s = 6) sin que un atacante que conozca p, g, A y B pueda deducir fácilmente la clave.