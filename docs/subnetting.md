...
Técnica fundamental en redes que permite dividir una red principal otras más pequeñas. Esto no solo mejora la eficiencia en el uso de direcciones IP, sino que también permite segmentar redes para mayor seguridad y control de tráfico.

## Características

* __Optimización__: se reduce el desperdicio de direcciones IP.
* __Segmentación__: facilita la gestión de redes complejas.
* __Control__: mejora el rendimiento al limitar el dominio de broadcast.
* __Seguridad__: permite aplicar reglas específicas por subred.
