...
Es la versión de línea de comandos de Wireshark, una herramienta de análisis de red. Permite capturar, filtrar y analizar tráfico, tambien permite filtrados avanzados para inspeccionar tráfico específico o depurar problemas de red.
