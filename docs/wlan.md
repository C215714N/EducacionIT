...
```sh
! Crear el SSID y definirlo para broadcast
dot11 ssid WIFI-CORPORATIVO
authentication open
guest-mode
!
! Configurar la clave de seguridad para el SSID
dot11 ssid WIFI-CORPORATIVO
authentication key-management wpa version 2
wpa-psk ascii Un4Cl4v3S3gur4!
!
! Acceder a la interfaz de radio 2.4GHz
interface Dot11Radio0
description 2.4GHz_RADIO_INTERFACE
! Asignar el SSID a la interfaz de radio
ssid WIFI-CORPORATIVO!
! Encender la interfaz de radio
no shutdown
```
