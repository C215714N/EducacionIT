...
let copyRight = document.querySelector('#copy'); // devuelve el primer elemento que coincida con el selector
...
/* ----------------------------------------------------------- */
copy.innerHTML = message; // Asignacion del valor en el HTML